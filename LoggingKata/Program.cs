...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 0)
            {
                logger.LogError("file doesn't have an input");
            }

            if (lines.Length == 1)
            {
                logger.LogWarning("file has one line of input");
            }
            ...
            logger.LogInfo($"{tacoBell1.Name} and {tacoBell2.Name} are {distance * 0.000621} miles apart");
